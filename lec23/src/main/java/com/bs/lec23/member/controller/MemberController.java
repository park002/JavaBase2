...
public class MemberController {
	...
	public String joinReg(Member member) { //A A A
		
		service.memberRegister(member); //A A A
	...
	public String loginForm(Member member) { //커맨드객체스
	...
	public String memLogin(Member member, HttpSession session) {
		...
		Member mem = service.memberSearch(member);// id,pw A A
		if(mem == null) 
			return "/member/loginForm";
